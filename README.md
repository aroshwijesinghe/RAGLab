...
- **Context Menu**: Right-click any supported text document (`.md`, `.txt`, `.json`, `.csv`) in your File Explorer or Editor and select **RAGLaB: Analyze Document** or **RAGLaB: Create Chunks**.
...
RAGLaB accepts text-native document formats for maximum tokenization accuracy and zero binary extraction corruption:

| Format | Extension | Common RAG Application |
| :--- | :--- | :--- |
| **Markdown** | `.md`, `.markdown` | Technical documentation, developer guides, README files, heading hierarchies |
